...
def generate_pdf(json_data, output_filename="market_report.pdf"):
    ...
    subtitle_style = ParagraphStyle(
        'SubtitleStyle', parent=styles['Normal'], fontSize=10, textColor=colors.slategray, spaceAfter=20, alignment=TA_CENTER
    )
    ...
    descriptions = [
        ...
        "&nbsp;&nbsp;&nbsp;&nbsp;• If \"N/A\", it means there are no 2 close prices available from the last 4 dates to calculate the change.",
...
if __name__ == "__main__":
    ...
    # Load the JSON data from the file generated by get_stock_info.py
